...
class AddItemDto {
  @ApiProperty({
    example: 'var_01abc',
    description: 'Product variant to include in each delivery cycle',
  })
  @IsString()
  variantId!: string;
...
class AddSlotDto {
  ...
  @ApiPropertyOptional({
    example: 8,
    description: 'Start hour (0–23) in local time',
  })
  @IsInt()
  @IsOptional()
  startHour?: number;
  ...
  @ApiPropertyOptional({
    example: 12,
    description: 'End hour (0–23) in local time',
  })
  @IsInt()
  @IsOptional()
  endHour?: number;
  ...
  @ApiPropertyOptional({
    example: 10,
    description: 'Max number of deliveries in this slot',
  })
  @IsInt()
  @IsOptional()
  capacity?: number;
...
export class PublicPlansController {
  ...
  @ApiOperation({
    ...
    description:
      'Public. Returns all active subscription plans with their items and time slots.',
  })
...
export class VendorPlansController {
  ...
  @ApiOperation({
    ...
    description:
      'Vendors create recurring delivery plans. Add items and time slots after creation.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Makes the plan visible to customers on the storefront. Plan must have at least one item and one slot.',
  })
  ...
  @Post(':id/items')
  @ApiOperation({
    summary: 'Add an item to a subscription plan',
    description: 'Adds a product variant to each delivery cycle of the plan.',
  })
  @ApiParam({ name: 'id', example: 'plan_01abc' })
  ...
  @Post(':id/slots')
  @ApiOperation({
    summary: 'Add a delivery time slot to a plan',
    description:
      'Defines available delivery windows for subscribers to choose from.',
  })
  @ApiParam({ name: 'id', example: 'plan_01abc' })
...
export class SubscriptionsController {
  ...
  @ApiOperation({
    ...
    description:
      'Creates a recurring subscription for the customer. The first cycle is scheduled automatically.',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Array of subscriptions with plan details',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Suspends future delivery cycles without cancelling the subscription.',
  })
  ...
  @Put(':id/skip')
  @ApiOperation({
    summary: 'Skip the next delivery cycle',
    description: 'Skips the upcoming cycle and resumes on the one after.',
  })
  @ApiParam({ name: 'id', example: 'sub_01abc' })
  ...
  @ApiOperation({
    ...
    description:
      'Permanently ends the subscription after the current cycle completes.',
  })
  @ApiParam({ name: 'id', example: 'sub_01abc' })
