...
export class CreateParcelDto {
  @ApiProperty({
    example: 'Sarah Nakato',
    description: 'Name of person at pickup point',
  })
  @IsString()
  pickupName!: string;
  ...
  @ApiProperty({
    example: 'John Mugisha',
    description: 'Name of recipient at drop-off',
  })
  @IsString()
  dropoffName!: string;
  ...
  @ApiProperty({
    ...
    example: ParcelSizeCategory.Small,
    description:
      'small (<1 kg), medium (1-5 kg), large (5-20 kg), extra_large (>20 kg)',
  })
  @IsEnum(ParcelSizeCategory)
  ...
  @ApiPropertyOptional({
    example: 50000,
    description: 'Declared value in UGX for insurance purposes',
  })
  @IsNumber()
  @IsOptional()
  @Min(0)
  ...
  @ApiPropertyOptional({
    example: 'quote_01abc',
    description: 'Pre-computed delivery quote ID',
  })
  @IsString()
  @IsOptional()
