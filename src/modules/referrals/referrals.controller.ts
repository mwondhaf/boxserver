...
class RedeemReferralDto {
  @ApiProperty({ example: 'JANE2025', description: 'Referral code shared by a friend' })
...
export class ReferralsController {
  ...
  @Get('my-code')
  @ApiOperation({ summary: 'Get my referral code', description: 'Returns the user\'s unique referral code to share with friends.' })
  ...
  @Post('redeem')
  @ApiOperation({ summary: 'Redeem a referral code', description: 'Applies a friend\'s referral code to the current user\'s account. Both users may receive a reward.' })
  ...
  @Get('my-referrals')
  @ApiOperation({ summary: 'List users I have referred', description: 'Returns all users who signed up using the current user\'s referral code.' })
