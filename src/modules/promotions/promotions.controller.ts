...
class CreatePromotionDto {
  @ApiProperty({
    example: 'WELCOME10',
    description: 'Unique discount code customers will enter at checkout',
  })
  @IsString()
  code!: string;

  @ApiProperty({
    enum: ['standard', 'buy_x_get_y', 'free_delivery'],
    example: 'standard',
  })
  @IsEnum(['standard', 'buy_x_get_y', 'free_delivery'] as const)
  type!: string;

  @ApiPropertyOptional({
    example: 'org_01abc',
    description:
      'Limit to a specific vendor (omit for platform-wide promotion)',
  })
  @IsString()
  @IsOptional()
...
export class AdminPromotionsController {
  ...
  @ApiOperation({
    ...
    description:
      'Returns all promotions (active, expired, and draft) with their discount rules.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Creates a new promotion code. Set discount rules and activate separately.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Makes the promotion code usable at checkout.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Expires the promotion so the code is no longer usable.',
  })
  @ApiParam({ name: 'id', example: 'promo_01abc' })
  ...
  @ApiOperation({
    ...
    description:
      'Groups multiple promotions under a named campaign (e.g. "Ramadan Specials").',
  })
...
export class VendorPromotionsController {
  ...
  @ApiOperation({
    ...
    description:
      "Returns promotions scoped to the authenticated vendor's organisation.",
  })
  @ApiResponse({ status: 200, description: 'Array of promotions' })
